 ...
 * bezier_test.c
 * 
 * Contains unit tests for the functions defined in bezier.h
 */
...
int main(int argc, char* argv[]) {
    ...
    //*************************************************************************
    printf("\nTesting function bez2EvaluateQuadratic:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;

    // test 1
    bez2EvaluateQuadratic(5.1, 7.71,
                          -6.86, 9.54,
                          -4.66, 2.78,
                          0.414,
                          &x, &y);
    ...
    // test 2
    bez2EvaluateQuadratic(-0.35, -9.5,
                          -8.57, -0.2,
                          6.44, 3.05,
                          0.754,
                          &x, &y);
    ...
    // test 3
    bez2EvaluateQuadratic(-9.53, 4.27,
                          -4.94, -4.74,
                          -7.7, 0.72,
                          0.031,
                          &x, &y);
    ...
    // test 4
    bez2EvaluateQuadratic(7.43, -3.23,
                          -9.3, -5.33,
                          -6.03, 5.09,
                          0.67,
                          &x, &y);
    ...
    // test 5
    bez2EvaluateQuadratic(9.04, -4.85,
                          0.28, -7.67,
                          9.67, -5.61,
                          0.88,
                          &x, &y);
    ...
    //*************************************************************************
    printf("\nTesting function bez2EvaluateLinear:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;

    // test 1
    bez2EvaluateLinear(9.25, -6.77,
                       6.76, -4.55,
                       0.811,
                       &x, &y);
    ...
    // test 2
    bez3Evaluate(-1.627, 1.590, 9.890,
                 6.000, -6.634, -4.713,
                 -8.020, 6.408, -2.321,
                 8.965, -9.773, 9.478,
                 0.887,
    ...
    // test 3
    bez3Evaluate(6.125, 3.297, 0.050,
                 -4.688, 3.332, 5.583,
                 -3.735, -9.641, -2.259,
                 -5.602, -1.328, -5.653,
                 0.372,
    ...
    // test 4
    bez3Evaluate(3.779, 1.244, 5.237,
                 -1.377, -5.720, 7.340,
                 0.612, -3.158, 3.000,
                 -1.787, -6.210, 3.324,
                 0.069,
    ...
    // test 5
    bez3Evaluate(-7.163, 2.407, 0.817,
                 6.783, -8.709, -6.997,
                 -9.094, 8.926, 0.450,
                 1.499, -0.647, -7.767,
                 0.029,
    ...
    //*************************************************************************
    printf("\nTesting function bez3EvaluateQuadratic:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;

    // test 1
    bez3EvaluateQuadratic(6.8, -5.2, -2.,
                          9.92, -3.7, 6.2,
                          -8.6, -1.5, 5.2,
                          0.455,
                          &x, &y, &z);
    ...
    // test 2
    bez3EvaluateQuadratic(-6.92, -6.05, 8.64,
                          -1.38, -7.55, -9.52,
                          -5.5, 8.64, 8.4,
                          0.696,
                          &x, &y, &z);
    ...
    // test 3
    bez3EvaluateQuadratic(9.55, 1.18, -6.33,
                          4.57, -8.32, -7.9,
                          9.5, 3.01, 1.53,
                          0.906,
                          &x, &y, &z);
    ...
    // test 4
    bez3EvaluateQuadratic(0.35, 7.13, -6.34,
                          0.32, 3.52, 5.9,
                          0.8, 8.8, 3.,
                          0.634,
                          &x, &y, &z);
    ...
    // test 5
    bez3EvaluateQuadratic(1.1, 8.13, 7.5,
                          7.61, 6.82, -8.63,
                          5.4, -2.06, 7.73,
                          0.927,
                          &x, &y, &z);
    ...
    //*************************************************************************
    printf("\nTesting function bez3EvaluateLinear:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;

    // test 1
    bez3EvaluateLinear(-6.77, 3.2, 8.3,
                       -8.43, 7.65, 4.08,
                       0.88,
                       &x, &y, &z);
    ...
    // test 2
    bez3EvaluateLinear(7.74, 4.94, -7.86,
                       -6.59, -4.86, 0.98,
                       0.508,
                       &x, &y, &z);
    ...
    // test 3
    bez3EvaluateLinear(5.51, -6.14, -5.42,
                       -1.81, 6.1, -5.44,
                       0.283,
                       &x, &y, &z);
    ...
    // test 4
    bez3EvaluateLinear(9.82, 9.25, -9.31,
                       5.15, -1.5, 3.32,
                       0.215,
                       &x, &y, &z);
    ...
    // test 5
    bez3EvaluateLinear(-5.63, 5.03, 5.33,
                       -4.22, 9.68, -1.25,
                       0.246,
                       &x, &y, &z);
    ...
    //*************************************************************************
    printf("\nTesting function bez2SplitCurve:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;
    failed = BEZ_FALSE;
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        bez2Evaluate(x0, y0, x1, y1, x2, y2, x3, y3, t, &x, &y);
        ...
        bez2Evaluate(x0, y0, x1, y1, x2, y2, x3, y3, t2, &x, &y);
        bez2Evaluate(a0, b0, a1, b1, a2, b2, a3, b3, t2 / t, &a, &b);
        ...
        bez2Evaluate(x0, y0, x1, y1, x2, y2, x3, y3, t2, &x, &y);
        bez2Evaluate(d0, e0, d1, e1, d2, e2, d3, e3, (t2 - t) / (1. - t), &d, &e);
    ...
    //*************************************************************************
    printf("\nTesting function bez3SplitCurve:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;
    failed = BEZ_FALSE;
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        bez3Evaluate(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, t, &x, &y, &z);
        ...
        t2 = randomUniform(0., t);
        bez3Evaluate(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, t2, &x, &y, &z);
        bez3Evaluate(a0, b0, c0, a1, b1, c1, a2, b2, c2, a3, b3, c3, t2 / t, &a, &b, &c);
        ...
        t2 = randomUniform(t, 1.);
        bez3Evaluate(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, t2, &x, &y, &z);
        bez3Evaluate(d0, e0, f0, d1, e1, f1, d2, e2, f2, d3, e3, f3, (t2 - t) / (1. - t), &d, &e, &f);
    ...
    //*************************************************************************
    printf("\nTesting function bez2Derivative:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;
    failed = BEZ_FALSE;
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        bez2Derivative(x0, y0, x1, y1, x2, y2, x3, y3, &a0, &b0, &a1, &b1, &a2, &b2);
        bez2EvaluateQuadratic(a0, b0, a1, b1, a2, b2, t, &a, &b);

        // compute estimate of derivative at t
        bez2Evaluate(x0, y0, x1, y1, x2, y2, x3, y3, t + DERIVATIVE_DELTA, &d0, &e0);
        bez2Evaluate(x0, y0, x1, y1, x2, y2, x3, y3, t - DERIVATIVE_DELTA, &d1, &e1);
    ...
    //*************************************************************************
    printf("\nTesting function bez2DerivativeQuadratic:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;
    failed = BEZ_FALSE;
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        // compute derivative at t
        bez2DerivativeQuadratic(x0, y0, x1, y1, x2, y2, &a0, &b0, &a1, &b1);
        bez2EvaluateLinear(a0, b0, a1, b1, t, &a, &b);

        // compute estimate of derivative at t
        bez2EvaluateQuadratic(x0, y0, x1, y1, x2, y2, t + DERIVATIVE_DELTA, &d0, &e0);
        bez2EvaluateQuadratic(x0, y0, x1, y1, x2, y2, t - DERIVATIVE_DELTA, &d1, &e1);
        d0 = (d0 - d1) / (2. * DERIVATIVE_DELTA);
        e0 = (e0 - e1) / (2. * DERIVATIVE_DELTA);
    ...
    //*************************************************************************
    printf("\nTesting function bez2DerivativeLinear:\n");
    //*************************************************************************
    num_tests = 5;
    num_fails = 0;
    failed = BEZ_FALSE;
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        bez2DerivativeLinear(x0, y0, x1, y1, &a, &b);

        // compute estimate of derivative at t
        bez2EvaluateLinear(x0, y0, x1, y1, t + DERIVATIVE_DELTA, &d0, &e0);
        bez2EvaluateLinear(x0, y0, x1, y1, t - DERIVATIVE_DELTA, &d1, &e1);
        d0 = (d0 - d1) / (2. * DERIVATIVE_DELTA);
        e0 = (e0 - e1) / (2. * DERIVATIVE_DELTA);
